...
export const metadata: Metadata = {
    ...
    description: "Koustav Mondal's portfolio website. A Flutter and Go developer.",
    icons: [{rel: "icon", url: "/favicon.ico"}],
    keywords: ["Koustav Mondal", "Flutter Developer", "Go Developer", "Linux", "Dart", "Go", "Flutter", "Developer", "Portfolio", "api", "rest", "ThunderBlast", "thunder"],
    authors: [{
        name: "Koustav Mondal",
